 ...
 * @author USER
 */
public class Loading11 extends javax.swing.JFrame {
    ...
    public Loading11() {
        ...
        Thread loadingThread = new Thread(new Runnable() {
            @Override
            public void run() {
                ImageIcon icon = new ImageIcon(Loading11.this.getClass().getResource("/img/icons8-bank-96.png"));
