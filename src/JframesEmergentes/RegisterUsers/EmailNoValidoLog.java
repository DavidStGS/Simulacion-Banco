 ...
 * @author USER
 */
public class EmailNoValidoLog extends javax.swing.JFrame {

    private final Login op;
       
    public EmailNoValidoLog() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El correo electrónico no tiene un formato válido.");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 260, -1));
        ...
        jPanel1.add(rSButtonGradiente2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 60, 60, 20));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 340, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmailNoValidoLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EmailNoValidoLog().setVisible(true);
        });
    }
